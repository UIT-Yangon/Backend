...
<div class="container w-50 flex justify-content-center align-items-center" style="border:1px solid black;border-radius:5px">
    <div class="text-black">
        <div class="card-body">
            <h4 class="card-tilte">Edit Industry Collaboration</h4>
            <form class="forms-sample" method="post" action="{{ route('ind#update', $industry->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="exampleInputName1" class="text-black">Industry Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control  bg-white" id="exampleInputName1" placeholder="Name"
                name="name" value="{{ old('name', $industry->name) }}" style="color:black !important; border:1px solid #3798A6 !important; ">
                    @error('name')
            ...
            <div class="form-group">
                ...
                name="country" value="{{ old('country', $industry->country) }}" style="color:black !important; border:1px solid #3798A6 !important; ">
                    @error('country')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
            </div>
            <div class="form-group">
                ...
                name="link" value="{{ old('link', $industry->link) }}" style="color:black !important; border:1px solid #3798A6 !important; ">
                    @error('link')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
            </div>
