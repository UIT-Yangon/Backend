        ...
        <div class="row text-black">
            <div class="col-8 offset-2">
                <div class="card  bg-white" style=" border-radius:20px; border: 1px solid #3798A6; border-radius:20px">
                    <h2 class="card-header pb-2 mb-4 text-center p-3" style="border-bottom: 3px solid white; color:#3798A6; border-radius:20px">Add Collaborated University</h2>
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('uni#store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a href="{{route('uni#list')}}"><button type="button" class="btn " style="background: white;  color:#3798A6">Cancel</button></a>
                        </form>
                    </div>
