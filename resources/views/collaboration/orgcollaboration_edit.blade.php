...
<div class="container w-50 flex justify-content-center align-items-center" style="border:1px solid black;border-radius:5px">
    <div class="text-black">
        <div class="card-body">
            <h4 class="card-tilte">Edit Organization Collaboration</h4>
            <form class="forms-sample" method="post" action="{{ route('org#update', $organization->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                name="name" value="{{ old('name', $organization->name) }}" style="color:black !important; border:1px solid #3798A6 !important; ">
                    @error('name')
            ...
            <div class="form-group">
                ...
                name="country" value="{{ old('country', $organization->country) }}" style="color:black !important; border:1px solid #3798A6 !important; ">
                    @error('country')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
            </div>
            <div class="form-group">
                ...
                name="link" value="{{ old('link', $organization->link) }}" style="color:black !important; border:1px solid #3798A6 !important; ">
                    @error('link')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
            </div>
